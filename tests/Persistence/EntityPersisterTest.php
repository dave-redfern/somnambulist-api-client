...
class EntityPersisterTest extends TestCase
{
    ...
    /**
     * @var \Somnambulist\Components\ApiClient\Persistence\EntityPersister
     */
    private $persister;
    ...
    protected function setUp(): void
    {
        ...
        $client = new Connection($client, $router);
    ...
    public function testStoreRaisesWrappedError()
    {
        ...
        $this->expectExceptionMessage('Entity of type "Somnambulist\Components\ApiClient\Tests\Stubs\Entities\User" could not be created');
